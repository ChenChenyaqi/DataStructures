...
public class RecursionB {
    ...
    final static int[] qua = {0, 2, 1, 2, 1, 3};
    // 四个特殊点之间的距离矩阵
    final static int[][] dist = {{0, 7, 8, 9, 9, 11},
            {7, 0, 1, 3, 4, 4},
            {8, 1, 0, 2, 3, 3},
            {9, 3, 2, 0, 1, 2},
            {9, 4, 3, 1, 0, 2},
    ...
    // 第d天从第i点走到第j点所消耗的水
    static int[][][] costx = new int[32][6][6];
    // 第d天从第i点走到第j点所消耗的食物
    static int[][][] costy = new int[32][6][6];
    // 第d天从第i点走到第j点所需要的的实际天数
    static int[][][] days = new int[32][6][6];
    static int ans = 0;
